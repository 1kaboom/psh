...
.LINK
https://exchangeserverpro.com/powershell-script-report-exchange-server-message-tracking-log-configuration
...
{
    $Exchange2013Report | Export-CSV -NoTypeInformation MessageTrackingLogConfig-Exchange2013.csv -Encoding UTF8
}

if ($Exchange2010Report)
{
    $Exchange2010Report | Export-CSV -NoTypeInformation MessageTrackingLogConfig-Exchange2010.csv -Encoding UTF8
}
